...
public class TwitchOAuth : MonoBehaviour
{
    ...
    [SerializeField] private string twitchClientId = "04c98e2v2o97g4qgtllx9btan9t1xm";
    [SerializeField] private string twitchClientSecret = "hlk4u4j1ki9igaq39c0qh0lnnnkuvm";
    ...
    [SerializeField] private TextMeshProUGUI uiTextToken = null;    // TODO : ui 출력에 쓰이는 거
    ...
    {
        _authToken = "oauth:";
        UpdateTokenDisplay();               // TODO : ui 출력에 쓰이는 거
        StartCoroutine(DisplayUpdater());   // TODO : ui 출력에 쓰이는 거
    }
    ...
    private void GetTokenFromCode(string code)
    {
        ...
        _authToken = _authToken + apiResponseData.access_token;
    }
